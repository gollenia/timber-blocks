		...
		<InspectorControls>
			...
			>
				...
				<ToggleControl
					...
					checked={ transparent }
					onChange={ ( value ) => {
						setAttributes( { transparent: value } );
					} }
				/>
				...
				colorSettings={ [
					{
						...
						value: customBackgroundColor ?? backgroundColor.color,
					...
					},
					{
						...
						value: customSecondaryColor ?? secondaryColor.color,
						disableCustomColors: false,
						defaultPalette: false,
					},
				] }
