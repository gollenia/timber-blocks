		...
		return (
			<Fragment>
				...
				<div style={style} className={classes}>
					...
					<InnerBlocks 
						allowedBlocks={['core/paragraph', 'core/heading', 'core/list', 'ctx-blocks/button', 'ctx-blocks/image', 'ctx-blocks/nav', 'ctx-blocks/posts', 'ctx-blocks/description-list', 'ctx-blocks/accordion', 'ctx-blocks/progress']}
						template={TEMPLATE}
					/>
