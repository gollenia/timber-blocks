...
import { DatePicker, TimePicker, TextControl, ToggleControl, SelectControl, PanelBody, PanelRow } from '@wordpress/components';
...
const Inspector = (props) => {
	...
	const onUpdateDate = ( dateTime ) => {
		setAttributes( { text: moment(dateTime).format( 'YYYY-MM-DD HH:mm' ) } );
	};
